...
public class DocumentServiceTest {
    ...
    public void should_add_2_documents_in_policy() throws QuoteCalculationException, PolicyValidationException {
        ...
        Document document1 = documentService.addDocument(policy, Base64.getEncoder().encode("something".getBytes()), "image/jpg", "Document Type");
        Document document2 = documentService.addDocument(policy, Base64.getEncoder().encode("something".getBytes()), "image/jpg", "Document Type");
    ...
    public void should_get_1_document_in_policy() throws QuoteCalculationException, PolicyValidationException {
        ...
        Document document = documentService.addDocument(policy, Base64.getEncoder().encode("something".getBytes()), "image/jpg", "Document Type");
        ...
        assertThat(document.getTypeName()).isEqualTo("Document Type");
