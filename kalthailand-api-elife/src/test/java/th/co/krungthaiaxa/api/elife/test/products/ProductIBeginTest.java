...
public class ProductIBeginTest {
    ...
    public void should_calculate_premium_from_sum_insured_with_yearly_periodicity_male_age_50() throws Exception {
        ...
        Quote quote = quoteService.createQuote(RequestFactory.generateSession(), ChannelType.LINE, ProductQuotationFactory.constructIBegin(50, EVERY_YEAR, 200000.0, true, GenderCode.MALE));
    ...
    public void should_calculate_premium_from_sum_insured_with_yearly_periodicity_female_age_50() throws Exception {
        Quote quote = quoteService.createQuote(RequestFactory.generateSession(), ChannelType.LINE, ProductQuotationFactory.constructIBegin(50, EVERY_YEAR, 200000.0, true, GenderCode.FEMALE));
        Amount result = quote.getPremiumsData().getFinancialScheduler().getModalAmount();
        assertThat(result.getCurrencyCode()).isEqualTo("THB");
    ...
    public void should_calculate_premium_from_sum_insured_with_half_year_periodicity_male_age_50() throws Exception {
        ...
        Quote quote = quoteService.createQuote(RequestFactory.generateSession(), ChannelType.LINE, ProductQuotationFactory.constructIBegin(50, EVERY_HALF_YEAR, 200000.0, true, GenderCode.MALE));
        Amount result = quote.getPremiumsData().getFinancialScheduler().getModalAmount();
        assertThat(result.getCurrencyCode()).isEqualTo("THB");
    ...
    public void should_calculate_premium_from_sum_insured_with_half_year_periodicity_female_age_50() throws Exception {
        ...
        Quote quote = quoteService.createQuote(RequestFactory.generateSession(), ChannelType.LINE, ProductQuotationFactory.constructIBegin(50, EVERY_HALF_YEAR, 200000.0, true, GenderCode.FEMALE));
        Amount result = quote.getPremiumsData().getFinancialScheduler().getModalAmount();
        assertThat(result.getCurrencyCode()).isEqualTo("THB");
    ...
    public void should_calculate_premium_from_sum_insured_with_quarterly_periodicity_male_age_50() throws Exception {
        ...
        Quote quote = quoteService.createQuote(RequestFactory.generateSession(), ChannelType.LINE, ProductQuotationFactory.constructIBegin(50, EVERY_QUARTER, 200000.0, true, GenderCode.MALE));
        Amount result = quote.getPremiumsData().getFinancialScheduler().getModalAmount();
        assertThat(result.getCurrencyCode()).isEqualTo("THB");
    ...
    public void should_calculate_premium_from_sum_insured_with_quarterly_periodicity_female_age_50() throws Exception {
        ...
        Quote quote = quoteService.createQuote(RequestFactory.generateSession(), ChannelType.LINE, ProductQuotationFactory.constructIBegin(50, EVERY_QUARTER, 200000.0, true, GenderCode.FEMALE));
        Amount result = quote.getPremiumsData().getFinancialScheduler().getModalAmount();
        assertThat(result.getCurrencyCode()).isEqualTo("THB");
    ...
    public void should_calculate_premium_from_sum_insured_with_monthly_periodicity_male_age_50() throws Exception {
        ...
        Quote quote = quoteService.createQuote(RequestFactory.generateSession(), ChannelType.LINE, ProductQuotationFactory.constructIBegin(50, EVERY_MONTH, 200000.0, true, GenderCode.MALE));
        Amount result = quote.getPremiumsData().getFinancialScheduler().getModalAmount();
        assertThat(result.getCurrencyCode()).isEqualTo("THB");
    ...
    public void should_calculate_premium_from_sum_insured_with_monthly_periodicity_female_age_50() throws Exception {
        ...
        Quote quote = quoteService.createQuote(RequestFactory.generateSession(), ChannelType.LINE, ProductQuotationFactory.constructIBegin(50, EVERY_MONTH, 200000.0, true, GenderCode.FEMALE));
        Amount result = quote.getPremiumsData().getFinancialScheduler().getModalAmount();
        assertThat(result.getCurrencyCode()).isEqualTo("THB");
    ...
    public void should_calculate_premium_from_sum_insured_with_yearly_periodicity_and_age_55() throws Exception {
        ...
        Quote quote = quoteService.createQuote(RequestFactory.generateSession(), ChannelType.LINE, ProductQuotationFactory.constructIBegin(55, EVERY_YEAR, 200000.0, true, GenderCode.MALE));
        Amount result = quote.getPremiumsData().getFinancialScheduler().getModalAmount();
        assertThat(result.getCurrencyCode()).isEqualTo("THB");
    ...
    public void should_calculate_premium_from_sum_insured_with_yearly_periodicity_and_age_60() throws Exception {
        ...
        Quote quote = quoteService.createQuote(RequestFactory.generateSession(), ChannelType.LINE, ProductQuotationFactory.constructIBegin(60, EVERY_YEAR, 200000.0, true, GenderCode.MALE));
        Amount result = quote.getPremiumsData().getFinancialScheduler().getModalAmount();
        assertThat(result.getCurrencyCode()).isEqualTo("THB");
    ...
    public void should_calculate_premium_from_sum_insured_with_yearly_periodicity_and_age_65() throws Exception {
        Quote quote = quoteService.createQuote(RequestFactory.generateSession(), ChannelType.LINE, ProductQuotationFactory.constructIBegin(65, EVERY_YEAR, 200000.0, true, GenderCode.MALE));
        Amount result = quote.getPremiumsData().getFinancialScheduler().getModalAmount();
        assertThat(result.getCurrencyCode()).isEqualTo("THB");
    ...
    public void should_calculate_premium_from_sum_insured_with_yearly_periodicity_and_age_70() throws Exception {
        Quote quote = quoteService.createQuote(RequestFactory.generateSession(), ChannelType.LINE, ProductQuotationFactory.constructIBegin(70, EVERY_YEAR, 200000.0, true, GenderCode.MALE));
        Amount result = quote.getPremiumsData().getFinancialScheduler().getModalAmount();
        assertThat(result.getCurrencyCode()).isEqualTo("THB");
