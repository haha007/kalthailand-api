...
public class CustomerAnniversary20Resource {
    ...
    @Autowired
    public CustomerAnniversary20Resource(CustomerAnniversary20Service customerAnniversary20Service, CustomerAnniversary20ExportService customerAnniversary20ExportService) {
    ...
    @ApiOperation(value = "Create Customer data for 'Krungthai-AXA 20th Anniversary'", notes = "Insert data of customer so that we can do upselling for the 'Krungthai AXA 20th Anniversary' campaign.")
    @RequestMapping(value = "/customer/campaign/krungthai-axa-20th-anniversary/report/download", produces = APPLICATION_JSON_VALUE, method = RequestMethod.GET)
    @ResponseBody
