...
@ApiModel(description = "iSafe Life Insurance specific Premiums Data")
public class ProductISafePremium implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        ProductISafePremium that = (ProductISafePremium) o;
